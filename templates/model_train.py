...
dict_path = 'D:\\Python36\\Projects\\newsWeb\\templates\\albert_xlarge_zh_183k\\vocab.txt'
...
def create_cls_model(num_labels):
    albert_model = load_brightmart_albert_zh_checkpoint('albert_large', training=False)
...
if __name__ == '__main__':
    ...
    train_df = pd.read_csv("C:/Users/Jarvan/Desktop/trainmini.csv").fillna(value="")
    test_df = pd.read_csv("C:/Users/Jarvan/Desktop/testmini.csv").fillna(value="")
